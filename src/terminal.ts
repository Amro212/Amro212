...
function buildFileSystem(): FSNode {
  ...
  const aboutFile: FSNode = {
    ...
    content: [
      ...
      '  - Practical Product and Systems Development',
    ].join('\n'),
  };
  ...
  const contactFile: FSNode = {
    ...
    content: [
      ...
      'Target roles: software engineering, AI automation, embedded systems.',
  ...
  const skillsFile: FSNode = {
    ...
    content: [
      ...
      'Web:          WordPress, web content systems, user-focused updates',
